...
class ModuleData1_16(ModuleData):  # noqa: N801
    """ModuleData class for Go v1.16 and UP."""

    def __init__(self, binary: Binary, offset: int) -> None:
        """Initialise the ModuleData for Go v1.16 and UP.
        ...
        """
        super().__init__(binary, offset, PcLineMagic.GO_1_16)
