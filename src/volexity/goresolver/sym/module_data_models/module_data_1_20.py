...
class ModuleData1_20(ModuleData):  # noqa: N801
    """ModuleData class for Go v1.20 and UP."""

    def __init__(self, binary: Binary, offset: int) -> None:
        """Initialise the ModuleData for Go v1.20 and UP.
        ...
        """
        super().__init__(binary, offset, PcLineMagic.GO_1_20)
    ...
    def _parse(self, reader: BinaryReader) -> None:
        ...
        _covctrs: Final[int] = reader.read_word()
        _ecovctrs: Final[int] = reader.read_word()
        ...
        _inittasks: Final[Slice] = reader.read_slice()
